  ...
  return (
    ...
    >
      <div className="relative h-56">
        ...
        <button
          onClick={() => isInCompare(listing.id) ? removeFromCompare(listing.id) : addToCompare(listing.id)}
          className="absolute bottom-3 left-3 p-2 bg-white/80 backdrop-blur-sm rounded-full hover:bg-white transition"
        >
      ...
      <div className="p-4">
        ...
        <Link
          ...
          className="mt-4 block text-center bg-black dark:bg-white text-white dark:text-black py-2 rounded-full text-sm hover:bg-gray-800 dark:hover:bg-gray-100 transition"
        >
          Подробнее
        </Link>
      </div>
