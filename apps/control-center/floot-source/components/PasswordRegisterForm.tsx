...
export const PasswordRegisterForm: React.FC<PasswordRegisterFormProps> = ({
  ...
  return (
    <Form {...form}>
      ...
      >
        <FormItem name="email">
          <FormLabel>Email администратора</FormLabel>
          <FormControl>
            <Input
              placeholder="name@pulsedv.ru"
        ...
        <FormItem name="displayName">
          ...
          <FormDescription>Будет отображаться в рабочем разделе</FormDescription>
          <FormMessage />
        </FormItem>
        ...
        >
          {isLoading ? (
            <>
              <Spinner size="sm" /> Создаём доступ...
            </>
          ) : (
            "Создать доступ"
          )}
